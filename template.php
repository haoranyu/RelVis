...
<head>
	...
	<title>RelVis | Visualizing Contact Frequency Changes Over Time in Email Relationships</title>
	...
	<script type="text/javascript" src="js/contactVis.js"></script>
...
<div id="right">
	...
	<div class="setting-checkbox-outer">
	<div class="showlabels setting-checkbox"><span check="false">Labels</span></div>
	<div class="selectall setting-checkbox"><span check="true">&nbsp;&nbsp;&nbsp;&nbsp;All</span></div>
	</div>
	<div class="invisible-clear"></div>
